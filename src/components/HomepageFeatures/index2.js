		...
		<StyleRoot>
			...
			<div class="container my-24 px-6 mx-auto">
				...
				<section class="mb-32 text-gray-800">
					<h2 class="text-3xl font-bold mb-12 text-center">Why is it so great?</h2>

					<div class="flex flex-wrap items-center">
						<div class="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6">
							<div class="relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-lg" data-mdb-ripple="true" data-mdb-ripple-color="light" className={styles.BgPosition50}>
								<img src="https://mdbootstrap.com/img/new/textures/full/98.jpg" class="w-full" />
								<a href="#!">
									<div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed" className={styles.Bg04}>
										<div class="flex justify-center items-center h-full">
											<div class="px-6 py-12 md:px-12 text-white text-center">
												<h3 class="text-2xl uppercase font-bold mb-6">
													The future is <u className={styles.Color210}>now</u>
												</h3>
												<p className={styles.Color210}>
									...
									<div class="relative overflow-hidden bg-no-repeat bg-cover">
										<div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 hover:opacity-100 transition duration-300 ease-in-out" className={styles.Bg251}></div>
									</div>
								</a>
							</div>
						</div>
						...
						<div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12 md:px-6">
							<div class="flex mb-12">
								<div class="shrink-0">
									<div class="p-4 rounded-md shadow-lg" className={styles.Bg204}>
								...
								<div class="grow ml-4">
									...
									<p class="text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil quisquam quibusdam modi sapiente magni molestias pariatur facilis reprehenderit facere aliquam ex.</p>
								</div>
							</div>
							...
							<div class="flex mb-12">
								...
								<div class="grow ml-4">
									...
									<p class="text-gray-500">Eum nostrum fugit numquam, voluptates veniam neque quibusdam ullam aspernatur odio soluta, quisquam dolore animi mollitia a omnis praesentium, expedita nobis!</p>
								</div>
							</div>
							...
							<div class="flex mb-12">
								...
								<div class="grow ml-4">
									...
									<p class="text-gray-500">Enim cupiditate, minus nulla dolor cumque iure eveniet facere ullam beatae hic voluptatibus dolores exercitationem? Facilis debitis aspernatur amet nisi iure eveniet facere?</p>
								</div>
							</div>
							...
							<div class="flex">
								...
								<div class="grow ml-4">
									...
									<p class="text-gray-500">Illum doloremque ea, blanditiis sed dolor laborum praesentium maxime sint, consectetur atque ipsum ab adipisci ullam aspernatur odio soluta, quisquam dolore</p>
								</div>
							</div>
						</div>
					</div>
