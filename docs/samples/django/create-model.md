...
![Create Django Model - Admin Interface.](<../../../static/assets/image (6).png>)

![Create Django Model - List Model Items](<../../../static/assets/image (7).png>)

![Django Create Model - Edit Model Item](<../../../static/assets/image (8).png>)
