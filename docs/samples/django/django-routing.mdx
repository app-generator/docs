---
sidebar_position: 4
sidebar_label: Django Routing Sample
description: Open-source sample provided by AppSeed to explain Django routing mechanism.
---

# Django Routing Sample

<SubHeading>Open-source sample provided by AppSeed to explain Django routing mechanism.</SubHeading>
...
> Read more about [Django Framework](../../content/what-is/django.mdx) - quick introduction
