---
sidebar_position: 1
sidebar_label: Django Create Model
description: Learn how to manage a new model in Django - free sample included.
---

# Django Create Model

<SubHeading>Learn how to manage a new model in Django - free sample included.</SubHeading>
...
> Check [Python](../../content/what-is/python.mdx) Version
