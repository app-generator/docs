---
title:         Django Material BS5 PRO - Premium Starter
sidebar_label: Django Material BS5 PRO
canonical:     https://appseed.us/product/material-dashboard2-pro/django/  
---

# [Django Material BS5 PRO](https://appseed.us/product/material-dashboard2-pro/django/)

<SubHeading>Premium Django Starter coded on top of Material Dashboard 2 PRO design (Premium Version).</SubHeading>

**[Django Dashboard](https://appseed.us/admin-dashboards/django/)** styled with **[Material Dashboard2 PRO](https://appseed.us/product/material-dashboard2-pro/django/)**, a premium `Bootstrap 5` KIT from `Creative-Tim`
The product is designed to deliver the best possible user experience with highly customizable feature-rich pages. 

- 👉 [Django Material BS5 PRO](https://appseed.us/product/material-dashboard2-pro/django/) - `Product page` 
- 👉 [Django Material BS5 PRO](https://django-material-dash2-pro.onrender.com/) - `LIVE Demo`

:::info [**v1.0.7**](https://github.com/app-generator/django-material-dashboard2-pro/releases) - release date `2024-08-13`, See [CHANGELOG](https://github.com/app-generator/django-material-dashboard2-pro/blob/master/CHANGELOG.md)
:::
