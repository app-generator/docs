---
title        : Django Black Dashboard - Open-Source Starter
sidebar_label: Django Black Dashboard
---
...
**Django** starter styled with **[Black Dashboard](https://appseed.us/product/black-dashboard/django/)**, an open-source `Bootstrap` Design 
from [Creative-Tim](https://www.creative-tim.com/product/black-dashboard?AFFILIATE=128200).
...
:::info [**v1.0.8**](https://github.com/app-generator/django-black-dashboard/releases) - release date `2023-01-31`
:::
...
- 🚀 [Django Black PRO](https://appseed.us/product/black-dashboard-pro/django/) - `Premium Version`
