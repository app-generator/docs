---
title        : Django Black - Open-Source Starter
sidebar_label: Django Black
---

# [Django Black](https://appseed.us/product/black-dashboard/django/)

<SubHeading>Open-source Django Starter coded on top Black Dashboard design (Free Version).</SubHeading>

**[Django Dashboard](https://appseed.us/admin-dashboards/django/)** styled with **[Black Dashboard](https://appseed.us/product/black-dashboard/django/)**, an open-source `Bootstrap` Design 
from `Creative-Tim`.
...
:::info [**v1.0.18**](https://github.com/app-generator/django-black-dashboard/releases) - release date `2024-05-18`, See [CHANGELOG](https://github.com/app-generator/django-black-dashboard/blob/master/CHANGELOG.md)
:::
...
- UI Theme: **Black Dashboard** BS4 from `Creative-Tim` 
