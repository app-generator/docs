...
# [Django Argon BS5 PRO](https://appseed.us/product/argon-dashboard2-pro/django/)
...
:::info [**v1.0.4**](https://github.com/app-generator/django-argon-dashboard2-pro/releases) - release date `2024-03-04`, See [CHANGELOG](https://github.com/app-generator/django-argon-dashboard2-pro/blob/master/CHANGELOG.md)
:::
