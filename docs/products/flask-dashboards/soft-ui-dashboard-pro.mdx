...
- [Set up the environment](../../boilerplate-code/flask-dashboard.mdx#environment) - prepare your workstation for Flask
- [Compile the sources](../../boilerplate-code/flask-dashboard.mdx#build-the-app) - start this Flask app in the local environment
- [App Codebase](../../boilerplate-code/flask-dashboard.mdx#app-codebase-simplified) - how the project files are organized
- [App Configuration](../../boilerplate-code/flask-dashboard.mdx#app-configuration) - how to configure this Flask application
