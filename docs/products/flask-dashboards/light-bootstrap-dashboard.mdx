...
- Codebase - [Flask Dashboard Boilerplate](../../boilerplate-code/flask-dashboard.mdx)
...
- [Compile the sources](../../boilerplate-code/flask-dashboard.mdx#build-the-app-1) - start this **Flask** app in the local environment
- [App Codebase](../../boilerplate-code/flask-dashboard.mdx#app-codebase) - how the project files are organized
