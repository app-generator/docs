...
<SubHeading>A curated index with all Jinja Templates provided by AppSeed</SubHeading>

[Jinja](https://jinja.palletsprojects.com/en/2.11.x/) is a modern and designer-friendly templating language for Python, modeled after Django’s templates. It is fast, widely used, and secure with the optional sandboxed template execution environment.

- [Jinja](https://palletsprojects.com/p/jinja/) - official webiste
- [What is Jinja](../../content/what-is/jinja.mdx) - a comprehensive introduction

> Jinja Templates - provided by AppSeed

- [Jinja AdminLTE](adminlte.mdx) - the iconic [AdminLTE](../../content/bootstrap-template/adminlte.mdx) dashboard now available in Jinja
- [Jinja Atlantis Lite](atlantis-lite.mdx) - open-source Bootstrap design
- [Jinja Datta Able PRO](datta-able-pro.mdx) - premium Bootstrap dashboard
- [Jinja Material Dashboard](material-dashboard.mdx) - design crafted by Creative-Tim
- [Jinja Paper Dashboard](paper-dashboard.mdx) - lightweight Bootstrap design
- [Jinja Dashkit](dashkit-v3.mdx) (legacy version) - premium dashboard styled with Bulma
- [Jinja Volt Bootstrap 5](volt-bootstrap-5.mdx) - a nice dashboard template designed by [Themesberg](../../content/partners/themesberg.mdx)
- [Jinja Volt Dashboard PRO](volt-dashboard-pro.mdx) - premium dashboard template
