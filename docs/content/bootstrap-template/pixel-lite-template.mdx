---
title:         Pixel Lite Template - Open-Source Template for Bootstrap 
sidebar_label: Pixel Lite Template
---
...
Pixel is a free, fully responsive, and modern **Bootstrap 5 UI Kit** that will help you build creative and professional websites. Use our components and sections, switch some Sass variables to build and arrange pages to best suit your needs - provided by [Themesberg](../partners/themesberg.mdx).
...
- [Flask Pixel Lite](../../products/flask-apps/pixel-lite.mdx) - open-source starter
- [Django Pixel Lite](../../products/django-apps/pixel-lite.mdx) - free Django starter
