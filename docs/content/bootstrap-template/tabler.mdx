---
title:         Tabler - Open-Source Template for Bootstrap 5
sidebar_label: Tabler
---

# Tabler Template

<SubHeading>Open source dashboard template with a responsive and high-quality UI.</SubHeading>
