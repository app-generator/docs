...
- [Soft UI Dashboard PRO](soft-ui-dashboard-pro.mdx) - Premium version (more pages and components)
...
To compile and start the project in a local environment a [minimum programming kit](../tutorials/minimal-programming-kit.mdx) must be installed and accessible via the terminal:
