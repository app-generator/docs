---
title            : Parse HTML Components
sidebar_label    : Parse HTML
---

# Parse HTML Components

<SubHeading>This page explains how to parse and extract information from a page (local or remote).</SubHeading>
...
For newcomers, **AppSeed** uses automation tools to convert lifeless UI Kits into simple starters generated in many frameworks and patterns. For instance, this open-source design - [**Pixel Lite**](../bootstrap-template/pixel-lite-template.mdx) provided by Themesberg has been _translated_ to [Flask](../../products/flask-apps/pixel-lite.mdx) and [Django](../../products/django-apps/pixel-lite.mdx) using **HTML parsing** as the first phase of the translation process.
...
At this point `html_page` variable contains the entire HTML content (string type) and we can use it in BS4 or Lxml to extract the components. 

To visualize the page structure we can use browser tools:
