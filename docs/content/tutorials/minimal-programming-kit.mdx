---
title            : Minimal Programming Kit
sidebar_label    : Programming Kit
---

# Minimal Programming Kit

<SubHeading>A short-list with tools for beginners and simple setup to build an open-source project.</SubHeading>

This page aims to help beginners to set up their PC for programming. All recommended tools are free, stable, and widely used even by experienced programmers and designers. 

In the end, we will build a popular open-source project using the downloaded tools.
...
To make this short tutorial useful, we will build in the local environment a popular open-source project from [Creative-Tim](https://www.creative-tim.com/?AFFILIATE=128200): 
[Material Kit](https://bit.ly/3u2lZc6) (free version) with a few commands typed in the terminal. **Material Kit** is a **Free Bootstrap 4 UI Kit** with a fresh, new design inspired by Google's material design.
