---
title        : Flask Apache Deployment
sidebar_label: Flask Deploy with Apache
---

# Flask Deploy on Apache

<SubHeading>How To configure Flask and Apache</SubHeading>
...
:::note Note
this setup was tested on CentOS but can be easily adapted to be executed on other platforms.
:::
...
To execute a Flask application under the Apache HTTP server we need to bridge our application to the Apache engine using the mod_wsgi module. 
For this we need to create a new file `wsgi.py` inside our project folder:
