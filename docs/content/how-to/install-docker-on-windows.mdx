...
sidebar_label: Docker Install on Windows
---

# Install Docker on Windows

<SubHeading> Learn how to install Docker Virtualization software on Windows Systems</SubHeading>
...
- Windows 11 64-bit
- Windows 10 64-bit
- [Install WSL](install-wsl.mdx) (Windows Subsystem for Linux)
