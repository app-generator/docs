...
<SubHeading>A simple guide for Next JS, a popular open-source React front-end web framework.</SubHeading>
...
To start using Next JS a [minimal programming kit](../tutorials/minimal-programming-kit.mdx) should be already installed with some of the tools:
