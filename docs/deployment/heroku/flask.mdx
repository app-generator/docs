---
title        : HEROKU - Deploy Flask
sidebar_label: Flask & HEROKU 
---

# Flask Deploy on HEROKU

<SubHeading>This page explains how to deploy a Flask application on Heroku, the popular deployment platform.</SubHeading>
...
_Flask Boilerplate_ is a template codebase used by the **AppSeed** platform to generate [Flask Apps](https://appseed.us/apps/flask/) enhanced with a basic set of features like authentication, database, ORM.
...
- `Procfile` - configuration file that informs Heroku where to look for the [WSGI](https://docs.appseed.us/content/what-is/wsgi/) interface
