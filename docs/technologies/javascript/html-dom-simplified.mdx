...
<img width="588" alt="Screenshot 2023-05-05 at 12 54 51" src="https://user-images.githubusercontent.com/67129211/236451707-5b3279a1-1da8-486e-a805-651f796a020e.png">
...
It allows you to access an HTML element via its id attribute. `document.getElementById` returns an entire element or null; if the element does not exist.    
