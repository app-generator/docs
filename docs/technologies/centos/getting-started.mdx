...
CentOS, short for Community Enterprise Operating System, was a free and open-source distribution of the Linux operating system. It was first released in 2004, based on the source code of Red Hat Enterprise Linux (RHEL). The project aimed to provide a stable and reliable platform for users who did not require the commercial support and services offered by Red Hat. Over the years, CentOS became a popular choice for servers and enterprise applications, as it offered long-term support and security updates.

> Topics covered

- How to install
  - Installing CentOS on a Laptop/Desktop
  - Installing CentOS in a Virtual Machine via `VirtualBox`
...
1. Install the PostgreSQL repository on your CentOS system.
...
5. Configure the database and user
...
1. Add MongoDB repository to your computer.
