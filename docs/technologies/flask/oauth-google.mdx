...
This article explains how to code an application that allows a user to log in using Google instead of creating a new account. 
The benefits of integrating this authentication flow is a stronger security and also a better user experience. 

To make this page more useful, an open-source sample is provided with all the code snippets explained in the following section. 

- 👉 [Flask Google OAuth](https://github.com/app-generator/flask-google-oauth) - free sample saved on GitHub
