...
### Populating the database with sales data
...
```bash
(venv) django-charts$ pip install django_plotly_dash
```
...
## Creating dynamic charts with Plotly
...
```
- From your browser, visit `http://127.0.0.1:8000/` to see the charts created using Plotly. To further style them, check out [ploty official documentation](https://plotly.com/python-api-reference/generated/plotly.graph_objects.Figure.html)
