...
![Home page of the Next.js project](<../../../static/assets/Screenshot 2022-08-15 at 22-41-56 Products page.png>)
...
export default function Product(props) {
	...
	return (
		<Card sx={{ maxWidth: 250, maxHeight: 250, margin: 4 }}>
			<CardActionArea>
				<CardMedia component="img" image={product?.image} height={100} width={100} />
				<CardContent>
