---
sidebar_position: 2
sidebar_label: Django User Profile
description: >-
...
<SubHeading>Free Django samples that allows registered users to edit their profile outside of the admin module.</SubHeading>
